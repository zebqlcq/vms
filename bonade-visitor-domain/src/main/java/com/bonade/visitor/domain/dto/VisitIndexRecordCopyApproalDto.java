...
/**
 * @author zoushaopeng
 * @title: VisitIndexRecordCopyApproalDto
 * @projectName bonade-vms
 * @description:
 * @date 2020/2/24 10:45
 */
public class VisitIndexRecordCopyApproalDto {
    ...
    /**
     *  抄送人审批状态: 0待审批（审批人） 1通过（审批人） 2拒绝（审批人） 3待阅览（抄送人）4 已阅览（抄送人）
     */
    @ApiModelProperty(value = "抄送人-审批状态: 0待审批（审批人） 1通过（审批人） 2拒绝（审批人） 3待阅览（抄送人）4 已阅览（抄送人）", name = "state", dataType = "Integer")
    private Integer state;

    @ApiModelProperty(value = "抄送人-审批状态名称", name = "stateName", dataType = "String")
     ...
     * 审批意见（抄送人）
     */
    @ApiModelProperty(value = "审批意见（抄送人）", name = "approvalOpinion", example = "")
    private String approvalOpinion;

    /**
     * 审批时间（抄送人）
     */
    @ApiModelProperty(value = "审批时间（抄送人）", name = "approvalTime", example = "")
    private LocalDateTime approvalTime;

    /**
     *  审批人
     */
    @ApiModelProperty(value = "审批人", name = "approvalCurrentName", dataType = "String")
    private String approvalCurrentName;

    /**
     * 审批通行时间
     */
    @ApiModelProperty(value = "审批通行时间", name = "approvalCurrentTime", example = "")
    private LocalDateTime approvalCurrentTime;
    ...
    public String getApprovalCurrentName() {
        return approvalCurrentName;
    }

    public void setApprovalCurrentName(String approvalCurrentName) {
        this.approvalCurrentName = approvalCurrentName;
    }

    public LocalDateTime getApprovalCurrentTime() {
        return approvalCurrentTime;
    }

    public void setApprovalCurrentTime(LocalDateTime approvalCurrentTime) {
        this.approvalCurrentTime = approvalCurrentTime;
    }
}
